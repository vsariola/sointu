...
BEGIN_PATCH
    BEGIN_INSTRUMENT VOICES(1)
        ...
        SU_ENVELOPE   STEREO(0),ATTACK(32),DECAY(32),SUSTAIN(64),RELEASE(64),GAIN(128)
        SU_OSCILLATOR STEREO(0),TRANSPOSE(64),DETUNE(32),PHASE(0),COLOR(15),SHAPE(96),GAIN(128),TYPE(3),LFO(0),UNISON(0)
        SU_OSCILLATOR STEREO(0),TRANSPOSE(72),DETUNE(64),PHASE(64),COLOR(170),SHAPE(64),GAIN(128),TYPE(3),LFO(0),UNISON(0)
        SU_MULP       STEREO(1)
